...
![图片](https://static001.geekbang.org/resource/image/4d/2c/4da01e06454368dd10a5294543dffd2c.png?wh=1522x1016){: referrerpolicy="no-referrer" }
...
![图片](https://static001.geekbang.org/resource/image/8a/94/8ae211da2eecc81688808a7d8ebeb794.png?wh=1124x914){: referrerpolicy="no-referrer" }
...
![图片](https://static001.geekbang.org/resource/image/42/9f/42f929a236521bc1ec71ee2bba632f9f.png?wh=1424x784){: referrerpolicy="no-referrer" }
...
![图片](https://static001.geekbang.org/resource/image/be/55/be705aaeyy10a28d2df1fe8db71bd055.png?wh=1545x969){: referrerpolicy="no-referrer" }
...
2. 使用的 Demo 镜像应用 “ACK-Cube” 为一个线上魔方游戏，我们将该游戏通过容器镜像部署到 ACK 集群中。完成课程后，你可以创建一个魔方游戏应用。  
   ![图片](https://static001.geekbang.org/resource/image/75/7f/75226cyy6ed7045fa562d19723225b7f.png?wh=1913x934){: referrerpolicy="no-referrer" }

### 操作步骤

![图片](https://static001.geekbang.org/resource/image/9f/d7/9fa3abe23d0755bcb4eeede2yy3331d7.png?wh=1517x138){: referrerpolicy="no-referrer" }
...
3. 在 ACK 托管版页签下，配置以下配置项。未说明配置项保留默认设置即可。  
   ![图片](https://static001.geekbang.org/resource/image/c2/00/c26b78yy33f5192cebc0f47f5e7ae500.png?wh=1760x1442){: referrerpolicy="no-referrer" }
4. 单击下一步：节点池配置，配置以下配置项。未说明配置项保留默认设置即可。  
   ![图片](https://static001.geekbang.org/resource/image/ee/4d/eeec5eee47ced96184ab4e481c868f4d.png?wh=1758x694){: referrerpolicy="no-referrer" }
...
![图片](https://static001.geekbang.org/resource/image/32/0f/32c437448efbe36fed08d43c7677780f.png?wh=1277x716){: referrerpolicy="no-referrer" }

![图片](https://static001.geekbang.org/resource/image/67/d6/67535bbdb9dbf809c3961c3daba8f9d6.png?wh=1756x818){: referrerpolicy="no-referrer" }
...
![图片](https://static001.geekbang.org/resource/image/a4/32/a4d96b3019455c86f12685617e3b3832.jpg?wh=1125x694){: referrerpolicy="no-referrer" }

![图片](https://static001.geekbang.org/resource/image/01/3e/01yy53c7279153ced704638851e32b3e.png?wh=1762x654){: referrerpolicy="no-referrer" }

8. 在高级配置页签，单击页面右下角的创建。创建成功后，默认进入创建完成页面，会列出应用包含的对象，你可以单击“查看应用详情”进行查看。

![图片](https://static001.geekbang.org/resource/image/ac/ec/ac53924a57ea350338dc67e9c473ccec.png?wh=391x179){: referrerpolicy="no-referrer" }
...
![图片](https://static001.geekbang.org/resource/image/78/8d/7803c97bd7915e0b84bfa8e0d36e288d.jpg?wh=1029x181){: referrerpolicy="no-referrer" }
