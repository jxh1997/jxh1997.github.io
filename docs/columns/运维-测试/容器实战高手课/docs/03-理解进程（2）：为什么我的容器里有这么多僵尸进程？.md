...
![](https://static001.geekbang.org/resource/image/dd/70/ddbd530325e12ec8b4ec1ab7e3fc8170.jpeg?wh=2199%2A1654){: referrerpolicy="no-referrer" }
...
问题三：Linux 为什么不设计成可以kill -9 杀死僵尸进程呢？现在把希望都寄托在父亲进程的代码质量上，而要init 回收，就得把init 到 僵尸进程之间的血缘进程全部杀死。为什么要做这样的设计呢？</p>2020-11-28</li><br/><li><span>上邪忘川</span> 👍（23） 💬（1）<p>总结一下这节课相关的东西
