...
![](https://static001.geekbang.org/resource/image/8c/ce/8c06230517da0ff6bfa5d7d1de1a24ce.jpg?wh=2119x1658){: referrerpolicy="no-referrer" }
...
![](https://static001.geekbang.org/resource/image/e6/f8/e6ac3bebf4c110e08031c776801643f8.jpg?wh=2218x1193){: referrerpolicy="no-referrer" }
...
![](https://static001.geekbang.org/resource/image/58/f9/5887a798530f4f6af0dbdbac43cb63f9.jpg?wh=2000x2073){: referrerpolicy="no-referrer" }

最后，我们就会看到生成了一个专门用于GitHub Action的身份提供商。这样认证工作就完成了。

![](https://static001.geekbang.org/resource/image/b5/45/b589e19fa6e55f976e23c866ae0df245.jpg?wh=2000x870){: referrerpolicy="no-referrer" }
...
![](https://static001.geekbang.org/resource/image/6b/f9/6ba2cd54128a1fe874c3082acdcf2df9.jpg?wh=2020x3401){: referrerpolicy="no-referrer" }

接着，点击启用存储桶版本，再点击默认加密启用即可。

![](https://static001.geekbang.org/resource/image/f7/7d/f778bd8786c095fd6a2710ba0d43097d.jpg?wh=2040x2046){: referrerpolicy="no-referrer" }
...
![](https://static001.geekbang.org/resource/image/61/56/618e671f59f735cf132d060895f6f356.jpg?wh=2000x1104){: referrerpolicy="no-referrer" }
...
![](https://static001.geekbang.org/resource/image/a3/86/a34579c9491ba79a2607368bb442f186.jpg?wh=945x929){: referrerpolicy="no-referrer" }
...
![](https://static001.geekbang.org/resource/image/5b/0e/5b5f13b08c883d6cyy7fa32eab285b0e.jpg?wh=2020x1495){: referrerpolicy="no-referrer" }

除了自定义策略之外，你也可以复用AWS自带的策略，你可以在角色的权限中选择附加策略，这里我附加上AmazonEC2FullAccess的策略，在接下来的EC2创建中，我们会使用到这个策略。

![](https://static001.geekbang.org/resource/image/6f/b7/6f753dd5747f396931a74a98b45e1ab7.jpg?wh=2138x665){: referrerpolicy="no-referrer" }
...
![](https://static001.geekbang.org/resource/image/a8/yy/a8245885814094ecca16c6ea022bf8yy.jpg?wh=2000x1295){: referrerpolicy="no-referrer" }
...
![](https://static001.geekbang.org/resource/image/48/bf/489208ff6108f3def811d3516c8928bf.jpg?wh=2000x744){: referrerpolicy="no-referrer" }

从图里我们可以看到，当Pull Request提交的时候，自动触发了Github Actions的流水线，此时正在运行的是terrafrom init以及terrafrom plan的步骤。

![](https://static001.geekbang.org/resource/image/b5/01/b5a7d492b88775deac2yyaa31f3c3801.jpg?wh=2000x2107){: referrerpolicy="no-referrer" }

从这个图中，我们可以看到，当Pull Request被merge的时候，自动触发了Github Actions的流水线，此时正在运行的是terrafrom apply这一步。

![](https://static001.geekbang.org/resource/image/55/dd/5524aeec718ee20ee96385cae1b10edd.jpg?wh=2020x2042){: referrerpolicy="no-referrer" }

最后，我们在AWS的页面上可以看到EC2实例创建成功了。

![](https://static001.geekbang.org/resource/image/75/81/75a73cc2fcd6a1ca8c904d98305ccf81.jpg?wh=2020x1600){: referrerpolicy="no-referrer" }

同时在S3存储桶中，我们可以看到Terraform的状态文件的不同版本，达到了安全地存储我们的管理文件，又能让我们拥有版本追溯的要求。

![](https://static001.geekbang.org/resource/image/d1/29/d114a69406f44a02c7fa5f271aec4029.jpg?wh=2252x673){: referrerpolicy="no-referrer" }
