...
![图片](https://static001.geekbang.org/resource/image/3c/d7/3c6c4b7721e08b01bfa483a4a26565d7.png?wh=1456x338){: referrerpolicy="no-referrer" }
...
![图片](https://static001.geekbang.org/resource/image/5c/bd/5ca67b4d1070aed6c57f1e1801318dbd.png?wh=981x814){: referrerpolicy="no-referrer" }

由于ginTools在部署时采用的是ClusterIP方式的服务暴露，这种方式只能在Kubernetes集群内部访问。为了在外部（例如浏览器）测试配置的DNS域名方式是否生效，我们需要为ginTools添加一个路由规则，将其暴露到外部网络。

![图片](https://static001.geekbang.org/resource/image/65/f0/650cf2fb5b1565ee64b88394d79e7bf0.png?wh=980x536){: referrerpolicy="no-referrer" }

![图片](https://static001.geekbang.org/resource/image/d9/24/d9659ef50b3f0a7055ace1b2b6883c24.png?wh=945x158){: referrerpolicy="no-referrer" }
...
![图片](https://static001.geekbang.org/resource/image/b1/df/b1b71e21174493d343382c4ffa4515df.png?wh=1910x422){: referrerpolicy="no-referrer" }
...
![图片](https://static001.geekbang.org/resource/image/9c/e7/9cf6ce78e3e74fc0e257bb2cb32c1ae7.png?wh=1489x573){: referrerpolicy="no-referrer" }

我让 Agent 帮我分析一下 gintools pod 的日志。得到的返回为：

![图片](https://static001.geekbang.org/resource/image/64/bf/6456bb296ba5c647c116a1b873472abf.png?wh=1489x610){: referrerpolicy="no-referrer" }
...
![图片](https://static001.geekbang.org/resource/image/d5/be/d5e4548d39d75ff78f7eff934ba716be.png?wh=1492x572){: referrerpolicy="no-referrer" }

结果如下：

![图片](https://static001.geekbang.org/resource/image/01/2c/015450461af591ff2132861fb1916b2c.png?wh=1494x515){: referrerpolicy="no-referrer" }
...
![图片](https://static001.geekbang.org/resource/image/e7/d4/e77f3a7e2d47d59f6ff65c7b6a4a0ed4.png?wh=1490x587){: referrerpolicy="no-referrer" }

测试结果：

![图片](https://static001.geekbang.org/resource/image/18/5a/1846e7c319d6e0c73cc46844cfdeaf5a.png?wh=1497x414){: referrerpolicy="no-referrer" }

看起来是得到了一坨 JSON，我们让大模型给我们格式化一下，看得更清楚一点：

![图片](https://static001.geekbang.org/resource/image/59/dd/59cc4e4349e1e6607943b2e540c3e4dd.png?wh=1229x294){: referrerpolicy="no-referrer" }

![图片](https://static001.geekbang.org/resource/image/67/8c/675e416b78a0ab598ac63f0c56479f8c.png?wh=1114x581){: referrerpolicy="no-referrer" }
