...
![图片](https://static001.geekbang.org/resource/image/1e/99/1e5f9548b31be6440e05cea4f6055999.png?wh=802x148){: referrerpolicy="no-referrer" }

再来查看一下 service。

![图片](https://static001.geekbang.org/resource/image/fb/32/fb898f5aeafc045f401c50219314a132.png?wh=1520x124){: referrerpolicy="no-referrer" }
...
![图片](https://static001.geekbang.org/resource/image/32/5f/3236fc439f3342e217d62bf261cb185f.png?wh=691x541){: referrerpolicy="no-referrer" }

设置好密码，登录后便进入到了控制台主页面。

![图片](https://static001.geekbang.org/resource/image/2c/56/2c2f54a7446e8e29707ef271b9607756.png?wh=1920x718){: referrerpolicy="no-referrer" }
...
![图片](https://static001.geekbang.org/resource/image/a4/5f/a4a1468yy5f5afe3cdcdfeef8e20585f.png?wh=1840x571){: referrerpolicy="no-referrer" }

接下来，我们可以在域名管理中，创建一个域名。如果你没有真域名的话，则需要在本地 hosts 文件中，做一下映射。

![图片](https://static001.geekbang.org/resource/image/37/69/371666c84c2581c86bdea0244351eb69.png?wh=1902x585){: referrerpolicy="no-referrer" }

之后就可以创建路由转发规则，将 /foo 路由映射到 foo 服务了。

![图片](https://static001.geekbang.org/resource/image/c1/2f/c1d46ee1723c1cacba8371aeb53d892f.png?wh=1274x1021){: referrerpolicy="no-referrer" }

完成后，可以在浏览器做一下测试。

![图片](https://static001.geekbang.org/resource/image/44/c9/4444f904a282b0d831074f52218865c9.png?wh=640x127){: referrerpolicy="no-referrer" }
