...
![图片](https://static001.geekbang.org/resource/image/b6/4b/b6d9d56b770d17f0192d8b4bd4a6074b.png?wh=1500x694){: referrerpolicy="no-referrer" }
...
![图片](https://static001.geekbang.org/resource/image/9d/0e/9da517d61a065fc9c1917380d71a5c0e.png?wh=1478x893){: referrerpolicy="no-referrer" }

## 体验测试

在已经在 Higress 上配置好 AI Proxy 的前提下，我们来尝试问一下：

![图片](https://static001.geekbang.org/resource/image/bf/d9/bf0e104b472c2073aae1fa6ecf68f0d9.png?wh=910x903){: referrerpolicy="no-referrer" }
...
![图片](https://static001.geekbang.org/resource/image/96/02/96yy67c488cf7yy66511f6e65bba2802.png?wh=1916x892){: referrerpolicy="no-referrer" }

点击左侧侧边栏的第三个按钮，就可以进入到发现页面。该页面中列出了已经支持的助手以及插件，可以直接使用。例如，我使用蛇年拜年小助手：

![图片](https://static001.geekbang.org/resource/image/24/2a/24c4d654ecd719ba0b65yy57e6a3722a.png?wh=899x895){: referrerpolicy="no-referrer" }

感觉是个提示词工程。

我们回到 Higress，继续测试插件。在 Higress 上将 AI Agent 插件打开后，并配置上心知天气的 API，再来测试一下效果。

![图片](https://static001.geekbang.org/resource/image/4c/80/4cc3b5c9e568100b022ab54186a45280.png?wh=1694x718){: referrerpolicy="no-referrer" }
