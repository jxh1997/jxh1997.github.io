...
![图片](https://static001.geekbang.org/resource/image/09/b2/09f60aca074c0d0da3d6c79439d111b2.png?wh=742x380){: referrerpolicy="no-referrer" }

第一轮回答：

![图片](https://static001.geekbang.org/resource/image/f0/27/f01e24ca677b059d997d8c85b14d6227.png?wh=626x263){: referrerpolicy="no-referrer" }

组装工具并进行 HTTP 请求：

![图片](https://static001.geekbang.org/resource/image/7b/4a/7b7d191556f8f234c32380027db5a44a.png?wh=1252x193){: referrerpolicy="no-referrer" }

从回复中可以看到，第一次请求出错了，原因是 text 参数的类型是一个字符串数组。

第二轮回复：

![图片](https://static001.geekbang.org/resource/image/a1/82/a12563a41a7e4b29dfeb269a73f61282.png?wh=808x259){: referrerpolicy="no-referrer" }

可以看到 Agent 进行了自我纠错。

![图片](https://static001.geekbang.org/resource/image/81/67/819ef4cdce8090f78d958aa15c18f167.png?wh=1284x214){: referrerpolicy="no-referrer" }

并且得到了正确的回复。

第三轮：

![图片](https://static001.geekbang.org/resource/image/89/b8/8968863a578b704c0b7082e5c72c0ab8.png?wh=1278x208){: referrerpolicy="no-referrer" }

得到了最终答案。同时我们在 apifox 工具上也得到了最终答案。

![图片](https://static001.geekbang.org/resource/image/67/84/67ab08a344a02b21452650c6e00e3684.png?wh=1022x225){: referrerpolicy="no-referrer" }

如果，将轮次限制设置为 1，则会得到“已超出允许的最大迭代次数”的回复。

![图片](https://static001.geekbang.org/resource/image/53/fd/5330441972742ebe7aaa860303ec25fd.png?wh=1043x207){: referrerpolicy="no-referrer" }
...
![图片](https://static001.geekbang.org/resource/image/yy/42/yy77d6cf84e761d40de8e405b51a9d42.jpg?wh=1503x834){: referrerpolicy="no-referrer" }
