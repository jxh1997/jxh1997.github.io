...
![图片](https://static001.geekbang.org/resource/image/95/d0/956970c8d61de9ec8a9fe528c9b7cbd0.png?wh=1920x1052){: referrerpolicy="no-referrer" }
...
![图片](https://static001.geekbang.org/resource/image/f5/c5/f53b78769774536faab548757dea8ec5.png?wh=1920x602){: referrerpolicy="no-referrer" }
...
![图片](https://static001.geekbang.org/resource/image/c0/8b/c006d2b2d6a9988cbb8b6206dbcbfc8b.png?wh=1920x449){: referrerpolicy="no-referrer" }

- 对于无法直接通过调用关系显现的变更，例如基础设施的调整，我们需要迅速检查业务核心指标的健康状况。这是因为关键故障往往会在业务指标上有所体现，从而影响整体服务表现。

![图片](https://static001.geekbang.org/resource/image/f2/aa/f2bca5d3cf4ae2c361caaf00622562aa.png?wh=1920x506){: referrerpolicy="no-referrer" }
...
![图片](https://static001.geekbang.org/resource/image/ec/97/ec63f7c39acd2e2b269d312d98e9c797.png?wh=1920x695){: referrerpolicy="no-referrer" }
