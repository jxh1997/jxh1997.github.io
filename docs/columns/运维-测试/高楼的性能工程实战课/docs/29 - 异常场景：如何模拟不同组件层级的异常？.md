...
![](https://static001.geekbang.org/resource/image/b4/e9/b4901e3b49f18e0401ed6ef0cd48d0e9.png?wh=2834%2A1604 "异常场景范围图"){: referrerpolicy="no-referrer" }
...
![](https://static001.geekbang.org/resource/image/47/e3/47f4b9cb42292cfacd2b5a0512a877e3.png?wh=831%2A643){: referrerpolicy="no-referrer" }

配置了以后，我们再去看实时流量中的Order服务：

![](https://static001.geekbang.org/resource/image/af/7b/af93b4e139a56ee7345b2e46b814597b.png?wh=1547%2A641){: referrerpolicy="no-referrer" }
...
![](https://static001.geekbang.org/resource/image/95/6a/951da503270d8d5b04fcd5d51638d66a.png?wh=1821%2A329){: referrerpolicy="no-referrer" }
...
![](https://static001.geekbang.org/resource/image/1b/f8/1bba2121a5b5411f5114b97753f20ff8.png?wh=1814%2A758){: referrerpolicy="no-referrer" }

可以看到，系统资源使用率也下降了，这就达到了限流的效果，至少我们保证了这个服务自己不会死。

对应到Sentinel中的数据，当我们把限流规则删掉之后，看到请求也是可以恢复的：

![](https://static001.geekbang.org/resource/image/54/yy/5402949501562c0159a4f9434389b2yy.png?wh=1508%2A423){: referrerpolicy="no-referrer" }
...
![](https://static001.geekbang.org/resource/image/b3/4c/b331e202ec1bfca9d6a6022568077a4c.png?wh=666%2A345){: referrerpolicy="no-referrer" }

然后，我们把打开首页的压力场景跑起来并持续运行一会，看看TPS曲线是个什么样子：

![](https://static001.geekbang.org/resource/image/bc/da/bc78414c8a0595d16c3b5d3bee9dedda.png?wh=1826%2A483){: referrerpolicy="no-referrer" }

这个结果很清楚，当场景运行了一段时间之后，由于响应时间大于降级规则中的最大响应时间10ms，所有请求随后被熔断10s，而在这10s中，TPS是直接掉到零的，并且也报了错。

我们再来看Sentinel中的TPS曲线图，是否和上图中的TPS曲线一致：

![](https://static001.geekbang.org/resource/image/97/2b/97d8775800b99dbcf20a2eb7c7dcdd2b.png?wh=1592%2A336){: referrerpolicy="no-referrer" }
...
![](https://static001.geekbang.org/resource/image/0a/37/0a447bc8a876f28548282377399efb37.png?wh=666%2A350){: referrerpolicy="no-referrer" }

我们来看看对应的TPS图：

![](https://static001.geekbang.org/resource/image/c0/d1/c0a5673c3bf6cb466804cce7d65535d1.png?wh=1830%2A480){: referrerpolicy="no-referrer" }
...
![](https://static001.geekbang.org/resource/image/a4/ca/a4f72ca94e739ca7402c2b73ee928bca.png?wh=1831%2A520){: referrerpolicy="no-referrer" }
...
![](https://static001.geekbang.org/resource/image/97/44/9736fc9e246fe0eb84cdc02a5904cd44.png?wh=1836%2A478){: referrerpolicy="no-referrer" }
...
![](https://static001.geekbang.org/resource/image/c3/da/c3d1f00yy7deefe879613970f3fe01da.png?wh=1834%2A269){: referrerpolicy="no-referrer" }
...
![](https://static001.geekbang.org/resource/image/4c/ed/4c3ecaa72b50ffe7327d706f6df024ed.png?wh=1827%2A257){: referrerpolicy="no-referrer" }
...
![](https://static001.geekbang.org/resource/image/df/8c/df79d22de9a2a6e55bce973aec7ae08c.png?wh=1830%2A263){: referrerpolicy="no-referrer" }
...
![](https://static001.geekbang.org/resource/image/61/61/6174b0fe2f9bb6df96ba545e045dd761.png?wh=1839%2A523){: referrerpolicy="no-referrer" }
...
![](https://static001.geekbang.org/resource/image/ac/f6/acyy165256bd5604b041b5725ebd3df6.png?wh=1823%2A523){: referrerpolicy="no-referrer" }
...
![](https://static001.geekbang.org/resource/image/91/d5/91697c6865yya651aa5418ec6b12afd5.png?wh=1779%2A43){: referrerpolicy="no-referrer" }
...
![](https://static001.geekbang.org/resource/image/9d/3b/9dd7dfe4c54894b5ac2d7020ed24343b.png?wh=1824%2A514){: referrerpolicy="no-referrer" }
...
![](https://static001.geekbang.org/resource/image/9f/10/9fa7562cf41011c3707512b9a22af010.png?wh=1834%2A480){: referrerpolicy="no-referrer" }
