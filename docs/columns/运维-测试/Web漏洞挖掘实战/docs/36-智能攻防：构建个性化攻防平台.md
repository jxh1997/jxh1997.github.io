...
![图片](https://static001.geekbang.org/resource/image/06/22/062342923ec379ae353490a2a1c23622.jpg?wh=1535x506){: referrerpolicy="no-referrer" }

## 对于工具/编排的使用

关于工具/编排的使用对应着使用说明文档的内容，你可以先对它进行浏览，这样在学习时会有一个大局观。

![图片](https://static001.geekbang.org/resource/image/23/2c/23b17cd7b08b5ed767e2b07a29a4262c.png?wh=1163x573){: referrerpolicy="no-referrer" }
...
![图片](https://static001.geekbang.org/resource/image/2e/e0/2e8d5687714190e32be252cfc4a7bde0.png?wh=1091x560){: referrerpolicy="no-referrer" }
...
![图片](https://static001.geekbang.org/resource/image/a9/ab/a913ef2494d1aa37b389cb1ff4ab37ab.png?wh=1786x1482){: referrerpolicy="no-referrer" }
...
![图片](https://static001.geekbang.org/resource/image/5f/2e/5f187b6a869148be743c1f6e5b165e2e.png?wh=997x566){: referrerpolicy="no-referrer" }
...
![图片](https://static001.geekbang.org/resource/image/7f/69/7f5e906yy679fd3c219e63dd20509569.png?wh=1287x730){: referrerpolicy="no-referrer" }

完成镜像的添加后，我们需要对景象的构建规则进行设置。具体的方式为在镜像管理中点击上传的镜像，然后选择构建规则，点击添加规则。

![图片](https://static001.geekbang.org/resource/image/c2/83/c2d2112b1a7439bd6b834ab0250bc483.png?wh=758x413){: referrerpolicy="no-referrer" }

之后根据GitHub中的类型，选择构建类型等信息，然后点击提交，即可完成镜像配置规则的设置。

![图片](https://static001.geekbang.org/resource/image/3e/9b/3ef91c61ef44e24bbbabdbc862a7139b.png?wh=1244x708){: referrerpolicy="no-referrer" }
...
![图片](https://static001.geekbang.org/resource/image/20/47/2068ffc92cf057e505be70784275c147.png?wh=1070x549){: referrerpolicy="no-referrer" }
...
![图片](https://static001.geekbang.org/resource/image/92/26/9266cc33b5f9221d21b564947d1f9f26.png?wh=1594x863){: referrerpolicy="no-referrer" }
