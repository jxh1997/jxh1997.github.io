...
![图片](https://static001.geekbang.org/resource/image/95/86/95026b5088302a5c1b24ec6c37bc7b86.jpg?wh=1380x404){: referrerpolicy="no-referrer" }
...
![图片](https://static001.geekbang.org/resource/image/d5/65/d5862f4f43937465ac7d674e6b573365.png?wh=1867x1086){: referrerpolicy="no-referrer" }

点开moreping编排，我们可以看到该编排的描述信息及使用说明。点击新建任务，我们可以看到如下配置页面：

![图片](https://static001.geekbang.org/resource/image/c8/4f/c89c8a3b7ec39ae93aa8b33a17bfcf4f.png?wh=1897x1109){: referrerpolicy="no-referrer" }
...
![图片](https://static001.geekbang.org/resource/image/46/47/467561df22cb417cd305d3623404d147.png?wh=1920x913){: referrerpolicy="no-referrer" }
...
![图片](https://static001.geekbang.org/resource/image/62/66/62da457a76c9380ceaa0e27850d9bd66.png?wh=1920x949){: referrerpolicy="no-referrer" }
...
![图片](https://static001.geekbang.org/resource/image/38/74/3829a352804835a00733341711786f74.png?wh=1920x954){: referrerpolicy="no-referrer" }
...
![图片](https://static001.geekbang.org/resource/image/85/b5/85560540517cbf57b88c7bdae3d387b5.png?wh=1766x964){: referrerpolicy="no-referrer" }

从页面中，我们可以知道它使用的服务器版本为Apache Tomcat/8.5.19，于是，我们可以打开潮汐社区版中的工具exploitdb，**这个工具可以根据关键词搜索相关的漏洞利用方式**。

![图片](https://static001.geekbang.org/resource/image/0f/59/0fb9c343984481a487dc1f3e437d0259.png?wh=1920x979){: referrerpolicy="no-referrer" }

我们选择simple模式的快速模式，输入Tomcat8.5.19，然后点击提交，任务就开始运行了。

![图片](https://static001.geekbang.org/resource/image/e6/a3/e6fa7edbb85c3e4ffe4bcd6ba4c478a3.png?wh=1920x951){: referrerpolicy="no-referrer" }

运行完成之后，我们可以看到如下返回信息，这代表我们可以在链接https://www.exploit-db.com/exploits/42966中获取到漏洞利用工具。

![图片](https://static001.geekbang.org/resource/image/10/27/10667b0d79aa26e39ebc0a12dcc09427.png?wh=1920x953){: referrerpolicy="no-referrer" }

访问这一地址后，我们下载其中的Exploit工具，获取到一个Python文件42966.py。

![图片](https://static001.geekbang.org/resource/image/65/22/659ba4d0211e45be8773b0dd661a3722.png?wh=1920x950){: referrerpolicy="no-referrer" }
...
![图片](https://static001.geekbang.org/resource/image/94/c6/9415e75ecf0c4be95d82d264c13337c6.png?wh=1120x483){: referrerpolicy="no-referrer" }
...
<li><span>ifelse</span> 👍（2） 💬（0）<p>学习打卡</p>2023-04-02</li><br/><li><span>chenyulan</span> 👍（0） 💬（0）<p>老师，麻烦问一下潮汐社区版地址是什么啊？都查不到啊</p>2024-09-04</li><br/><li><span>chenyulan</span> 👍（0） 💬（0）<p>潮汐.开源社区这个访问地址是什么？一直都找不到</p>2024-09-04</li><br/><li><span>eddy</span> 👍（0） 💬（0）<p>信息收集</p>2023-05-05</li><br/><li><span>love the way</span> 👍（0） 💬（0）<p>老师能给个邀请码吗？注册平台</p>2022-04-05</li><br/>
</ul>
