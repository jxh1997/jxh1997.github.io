...
![](https://static001.geekbang.org/resource/image/ba/7f/baa46539d6992c656e6469726b9a9f7f.jpg?wh=524x450){: referrerpolicy="no-referrer" }
...
![](https://static001.geekbang.org/resource/image/9e/2c/9ea738e159bd4f2d5cf00e17ea69102c.jpg?wh=1076x239){: referrerpolicy="no-referrer" }
...
![](https://static001.geekbang.org/resource/image/b1/ca/b1e20926e584bbd335be84442d9fedca.jpg?wh=747x519){: referrerpolicy="no-referrer" }

- **第三步：在过滤出来的TCP流中进一步分析**

在我们点击TCP Stream的时候，Wireshark会弹出一个窗口，显示解读好的应用层信息。如果是HTTP明文（非HTTPS加密），那就可以直接看到里面的内容了。

![](https://static001.geekbang.org/resource/image/bb/ce/bb5faedc20ae2150a66f0b8e3c0e35ce.jpg?wh=906x251){: referrerpolicy="no-referrer" }

回到主窗口，此时过滤生效，所以只有属于这个TCP流的包才被显示，其他无关的数据包都已经被隐藏了。

![](https://static001.geekbang.org/resource/image/fd/68/fda1ff0889d2a2a614a210028eea5a68.jpg?wh=634x121){: referrerpolicy="no-referrer" }

可见，TCP三次握手后，客户端发起了一个HTTP请求，即GET /overview HTTP/1.1，但服务端回复的是TCP RST，怪不得访问失败了。我画了下面这张示意图供你参考：

![](https://static001.geekbang.org/resource/image/59/2f/59f9dc3eed0186d8503eb935yyf3982f.jpg?wh=2000x904){: referrerpolicy="no-referrer" }
...
![](https://static001.geekbang.org/resource/image/9f/76/9f9c388a51e688cf4e3df44628194576.jpg?wh=2000x520){: referrerpolicy="no-referrer" }
...
![](https://static001.geekbang.org/resource/image/ff/7f/ffe7b69e697e52549ea194c2f6e3fb7f.jpg?wh=546x269){: referrerpolicy="no-referrer" }
...
![](https://static001.geekbang.org/resource/image/87/2f/870b69feb1406c744fe33f75607e212f.jpg?wh=528x106){: referrerpolicy="no-referrer" }
...
![](https://static001.geekbang.org/resource/image/63/32/63f0f21dded5e5fd7f91d0175b3bc432.jpg?wh=595x131){: referrerpolicy="no-referrer" }

因为TTL并不是默认的展示列，所以我们需要选中报文，然后到IP详情部分去查看，像下面这样：

![](https://static001.geekbang.org/resource/image/76/f7/767yy4d279bd8d6834e77a2c423b14f7.jpg?wh=1102x578){: referrerpolicy="no-referrer" }
...
![](https://static001.geekbang.org/resource/image/5e/71/5ec050646e50d0f373279b6ef3462571.jpg?wh=819x416){: referrerpolicy="no-referrer" }

- 然后在主窗口中，就多出了一列Time to live，对比起来非常方便。

![](https://static001.geekbang.org/resource/image/bc/36/bcb25393d56c8aeceab1825a17f8ca36.jpg?wh=1984x276){: referrerpolicy="no-referrer" }
...
![](https://static001.geekbang.org/resource/image/04/29/042f29c03e83332c9dbce93383d89129.jpg?wh=2000x525){: referrerpolicy="no-referrer" }
...
![](https://static001.geekbang.org/resource/image/74/86/749e8905b7b1728f7c523c309fa3b886.jpg?wh=705x219){: referrerpolicy="no-referrer" }
...
![](https://static001.geekbang.org/resource/image/bb/f3/bb993ceb3733edbb80fdc38559709cf3.jpg?wh=850x146){: referrerpolicy="no-referrer" }

图中可见，TCP三次握手正常完成了，随后的TLS握手Client Hello包也发送出来了，但是服务端回复的是RST包，这也就是引起客户端显示connection reset by peer报错的原因。

接着，我们再来看下服务端抓包文件的情况：

![](https://static001.geekbang.org/resource/image/a9/9f/a9a90767e9678151f3137eace0d35a9f.jpg?wh=875x114){: referrerpolicy="no-referrer" }

显然，这里也有一个从客户端回复的TCP RST。

不过，再仔细对比服务端抓包和客户端抓包，是不是有些异样呢？为什么客户端抓包里有TLS Client Hello报文，但在服务端抓包里却没有呢？是因为Client Hello报文延迟了吗？

![](https://static001.geekbang.org/resource/image/fb/7d/fb59565b2yyf833fa7b39610bf87637d.jpg?wh=2000x1125){: referrerpolicy="no-referrer" }
...
![](https://static001.geekbang.org/resource/image/37/df/3704b5045ec543b4yy6a4e2909620cdf.jpg?wh=583x301){: referrerpolicy="no-referrer" }

下图是RST包：

![](https://static001.geekbang.org/resource/image/cd/81/cd5ffe857073fd7f997a0yy891b6ab81.jpg?wh=513x292){: referrerpolicy="no-referrer" }
...
![](https://static001.geekbang.org/resource/image/45/ac/45ea9fe82772b67cca4ebae84248caac.jpg?wh=1124x440){: referrerpolicy="no-referrer" }

客户端收到的RST包的TTL是54：

![](https://static001.geekbang.org/resource/image/c8/ee/c887e9a8fd6af5b20b34c5d23f7175ee.jpg?wh=1080x426){: referrerpolicy="no-referrer" }

终于，结合两侧的抓包，我们就可以把这个拼图给拼完整了，而Client Hello报文丢失之谜，也将揭晓。更新一下前面的示意图，会变成下面这样。显然，Client Hello报文就是被防火墙丢弃了。

![](https://static001.geekbang.org/resource/image/0f/c8/0f4277b5b171eb189f487d32e7a420c8.jpg?wh=2000x1125){: referrerpolicy="no-referrer" }
...
![](https://static001.geekbang.org/resource/image/bd/14/bd1ae50db55ea5d960787a241efff914.jpg?wh=2000x740){: referrerpolicy="no-referrer" }

### 实验1：telnet第三方站点

在1上，直接telnet [www.baidu.com](https://www.baidu.com) 443，可以成功。

![](https://static001.geekbang.org/resource/image/f3/19/f352e677d3eb81f7bdd2122a3dd83719.jpg?wh=666x164){: referrerpolicy="no-referrer" }
...
![](https://static001.geekbang.org/resource/image/0d/80/0df85df7ba457f5f5a6476c0b52cfe80.jpg?wh=830x106){: referrerpolicy="no-referrer" }

原来，我们还需要设置一下NAT，要不然出去的报文源IP是100.64.0.1，回包也会回这个地址，显然回不到2了。

![](https://static001.geekbang.org/resource/image/0e/b2/0ef388aa8ba51dd283cc465110df37b2.jpg?wh=2000x779){: referrerpolicy="no-referrer" }
...
![](https://static001.geekbang.org/resource/image/fd/32/fd31162403e5efe41a3f044e1f787832.jpg?wh=680x172){: referrerpolicy="no-referrer" }
...
![](https://static001.geekbang.org/resource/image/07/58/07a9100e6dbb2f963062039611911158.jpg?wh=2000x785){: referrerpolicy="no-referrer" }
...
![](https://static001.geekbang.org/resource/image/89/bb/898e33a81b5bfdecc78e22a98d2415bb.jpg?wh=906x138){: referrerpolicy="no-referrer" }
...
![](https://static001.geekbang.org/resource/image/8a/09/8a5afaa9f464219e6a0cb1cf526f4809.jpg?wh=2000x778){: referrerpolicy="no-referrer" }
