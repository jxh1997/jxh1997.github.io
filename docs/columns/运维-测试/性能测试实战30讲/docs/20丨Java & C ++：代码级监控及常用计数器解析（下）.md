...
![](https://static001.geekbang.org/resource/image/c1/19/c12c874e2048b88e71510ad5fb3af319.png?wh=376%2A96)  {: referrerpolicy="no-referrer" }
...
![](https://static001.geekbang.org/resource/image/e3/38/e3b1d3c0eb74914f3f3e04d4483f4d38.png?wh=594%2A269){: referrerpolicy="no-referrer" }
...
![](https://static001.geekbang.org/resource/image/b8/4b/b8f84cf6e690b84b98ded381e8e0ba4b.png?wh=777%2A349){: referrerpolicy="no-referrer" }

从这张图可以看到，当应用在压力场景之后，GC并没有消耗过多的CPU。

**场景二：典型的内存分配过多的场景**

![](https://static001.geekbang.org/resource/image/2d/d5/2ddbc9cf8f99e5d13c8d2b65b26dbcd5.png?wh=738%2A393){: referrerpolicy="no-referrer" }
...
![](https://static001.geekbang.org/resource/image/7f/72/7f3c24cf57f51588fdb0657ee8983572.png?wh=667%2A280){: referrerpolicy="no-referrer" }
...
![](https://static001.geekbang.org/resource/image/0c/c6/0cd248b5d32fa7c6b2bb34f3c1332dc6.png?wh=550%2A487){: referrerpolicy="no-referrer" }
...
![](https://static001.geekbang.org/resource/image/50/8e/502a6ed2d254820ce92ab6bd22b2928e.png?wh=659%2A291){: referrerpolicy="no-referrer" }

我们在内存中经常看到的对象是这样的。

![](https://static001.geekbang.org/resource/image/ed/9e/ed0fbdbfa94a97380a86c7730b2db49e.png?wh=1339%2A628){: referrerpolicy="no-referrer" }

如果你用jmap的话，会看到如下信息。

![](https://static001.geekbang.org/resource/image/fe/2b/fec55fa1419b3e87be9e1d9adf06982b.png?wh=1366%2A768){: referrerpolicy="no-referrer" }
...
![](https://static001.geekbang.org/resource/image/b1/70/b1373d88b3799c573d618545141dca70.png?wh=1337%2A602){: referrerpolicy="no-referrer" }

在刚开始点击Deltas之后，会看到全是零的对象。

下面我们来做下压力，观察一下。

![](https://static001.geekbang.org/resource/image/ee/40/eebbb6e45916a8f3f4fb4f5c43538c40.png?wh=1339%2A601){: referrerpolicy="no-referrer" }
...
![](https://static001.geekbang.org/resource/image/74/cc/7438e6e9df188a85edc5906a22852fcc.png?wh=1338%2A605){: referrerpolicy="no-referrer" }

临时的对象也都清理了。 这就是正常的结果。

如果停止压力之后，又做了正常的FullGC回收了之后，还是像下面这样。

![](https://static001.geekbang.org/resource/image/73/6e/73e145ffcad24c4b72bb5c33b92e8b6e.png?wh=1340%2A588){: referrerpolicy="no-referrer" }
...
![](https://static001.geekbang.org/resource/image/ac/21/ac38b7a41afa0b4eef5ea8282494a421.png?wh=720%2A345){: referrerpolicy="no-referrer" }

2.找到内存消耗点的多的内容。如下所示。

![](https://static001.geekbang.org/resource/image/c7/ec/c77ccf1e96b1794987354fac146cc6ec.png?wh=1071%2A563){: referrerpolicy="no-referrer" }

这是一个实体bean。每个倒是不大，但是架不住有79万个。

3.看它对应的栈。

![](https://static001.geekbang.org/resource/image/0e/1f/0e7914173204f8609c45c24944655f1f.png?wh=1219%2A581){: referrerpolicy="no-referrer" }

就是一个数据库操作。

4.取出SQL，查看执行计划如下。

![](https://static001.geekbang.org/resource/image/fd/8d/fd1c9859d61fb9bc531b3a10449b318d.png?wh=638%2A483){: referrerpolicy="no-referrer" }
...
![](https://static001.geekbang.org/resource/image/54/c4/54f34188238d4dad62f9fd1ed5fdf5c4.png?wh=564%2A157){: referrerpolicy="no-referrer" }

执行这个文件，就会生成test.prof文件。

![](https://static001.geekbang.org/resource/image/42/7d/42fa660a548ffdaf7a9f84e92a2bef7d.png?wh=568%2A227){: referrerpolicy="no-referrer" }
...
![](https://static001.geekbang.org/resource/image/f6/58/f69e0653da960428fb4f308578508758.png?wh=753%2A530){: referrerpolicy="no-referrer" }

你看到上面有很多只有地址而没有函数名的调用吗？那是没有符号表。这里我们不分析那些不是我们自己的函数，我们只看自己的函数f。

![](https://static001.geekbang.org/resource/image/d3/11/d3728112e6b6eb636aea729c0a5b9211.png?wh=276%2A153){: referrerpolicy="no-referrer" }
...
![](https://static001.geekbang.org/resource/image/60/f8/6098d8b66b331a1791cc8daaeaa186f8.png?wh=2248%2A1056){: referrerpolicy="no-referrer" }
