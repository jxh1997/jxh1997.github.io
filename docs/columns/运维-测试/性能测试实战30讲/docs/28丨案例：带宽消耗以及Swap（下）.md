...
![](https://static001.geekbang.org/resource/image/1f/e5/1fd061cbf986f9cea3509bd4699ddbe5.jpg?wh=285%2A111){: referrerpolicy="no-referrer" }
...
![](https://static001.geekbang.org/resource/image/e2/7f/e29ec84d980fb9e667e41010b209427f.png?wh=735%2A268){: referrerpolicy="no-referrer" }
...
![](https://static001.geekbang.org/resource/image/8d/ba/8d6525787d1234c738f629389b5da5ba.png?wh=1359%2A180){: referrerpolicy="no-referrer" }
...
![](https://static001.geekbang.org/resource/image/ef/66/ef8154abc5d60e04752a5d9ea29d4966.png?wh=686%2A503){: referrerpolicy="no-referrer" }
...
![](https://static001.geekbang.org/resource/image/d8/f1/d84de678e28c64b46b1b69b8b30b77f1.png?wh=1652%2A900){: referrerpolicy="no-referrer" }
...
![](https://static001.geekbang.org/resource/image/40/44/40116bf5ff367647f3f41143fd47fd44.png?wh=1494%2A895){: referrerpolicy="no-referrer" }

CPU使用率相对前面没有什么变化，但是堆4G只用到了1.5G，可见这个堆连4G都用不到。当然我们还是要分析下其他的内容。

还记得我们要解决的是什么问题吧？swap飘黄了！

![](https://static001.geekbang.org/resource/image/d8/1f/d8ec1c105537e046a98440790462f91f.png?wh=1306%2A866){: referrerpolicy="no-referrer" }
...
![](https://static001.geekbang.org/resource/image/10/67/1002a324619b0fe3ba5d6a0d7af53e67.png?wh=682%2A572){: referrerpolicy="no-referrer" }

应用服务器系统资源top：

![](https://static001.geekbang.org/resource/image/61/41/61b13011e46b803fef61dde5030e4541.png?wh=601%2A112){: referrerpolicy="no-referrer" }

应用服务器系统资源iftop:

![](https://static001.geekbang.org/resource/image/41/de/4109d34df75fed3d71cdc842d516d9de.png?wh=387%2A63){: referrerpolicy="no-referrer" }
...
![](https://static001.geekbang.org/resource/image/85/27/851e322ad9561715a30fc1ce79052027.png?wh=702%2A486){: referrerpolicy="no-referrer" }

你可以看到数据库CPU都用到这么高了？

![](https://static001.geekbang.org/resource/image/f3/2b/f36982dff7c811cbe9d5ca8d9cf0862b.png?wh=912%2A124){: referrerpolicy="no-referrer" }
...
![](https://static001.geekbang.org/resource/image/dc/c4/dc2569aa95f7eab54930c479ee8b04c4.png?wh=661%2A147){: referrerpolicy="no-referrer" }
...
![](https://static001.geekbang.org/resource/image/bd/09/bd2d900a6d737649dcccf53c81584409.png?wh=587%2A825){: referrerpolicy="no-referrer" }

从上面的图可以看到，CPU使用率99%，Query Cache 是OFF的。记下这个位置！

![](https://static001.geekbang.org/resource/image/c2/1d/c2c538d0c263c6e87d77b3b78402151d.png?wh=1449%2A913){: referrerpolicy="no-referrer" }

从上图看到，负载队列非常长，但Disk I/O没多少，说明队列和I/O无关，只是CPU的队列，非常好！

Network也不算大，进出每秒5000多个包，我们再来看一下网络用到多少了？

![](https://static001.geekbang.org/resource/image/3e/c7/3eb362a32b7bcaabce509dbd790286c7.png?wh=390%2A62){: referrerpolicy="no-referrer" }

峰值也才70Mbps左右，即使是100Mbps带宽，现在仍然认为有余量（注意！我这里说有余量是因为我同时也检查了网络队列，并没有阻塞，并不是只看了这个值就武断地做了判断）。

![](https://static001.geekbang.org/resource/image/cf/63/cf347ab9406ffcb3a281f1ef4a646263.png?wh=1328%2A403){: referrerpolicy="no-referrer" }

![](https://static001.geekbang.org/resource/image/23/ec/23e8f83c88e76c1c44badabaea44deec.png?wh=1390%2A830){: referrerpolicy="no-referrer" }
...
![](https://static001.geekbang.org/resource/image/77/69/7746e95a65b8ca2537672ccd5a474c69.png?wh=1272%2A80){: referrerpolicy="no-referrer" }
...
![](https://static001.geekbang.org/resource/image/ec/c4/ecbcccf81290dc50cb6192782500cfc4.png?wh=1357%2A79){: referrerpolicy="no-referrer" }
...
![](https://static001.geekbang.org/resource/image/a5/b7/a5fb75d8b6af58760d2eb7f9976df4b7.png?wh=633%2A145){: referrerpolicy="no-referrer" }

效果还不错哦，us CPU降到了50%以下。

![](https://static001.geekbang.org/resource/image/81/e9/81652d6852324114300d4b36355f31e9.png?wh=383%2A56){: referrerpolicy="no-referrer" }

网络峰值时能达到90Mbps了，又快把带宽占完了。

查看网络队列：

![](https://static001.geekbang.org/resource/image/29/8c/297e4d951b9b1aa3e439137aab87598c.png?wh=202%2A514){: referrerpolicy="no-referrer" }

再检查下队列，这时看到已经有接收队列了。

![](https://static001.geekbang.org/resource/image/4a/09/4a813c91a6a79d3ff359666c581f3c09.png?wh=1133%2A386){: referrerpolicy="no-referrer" }
