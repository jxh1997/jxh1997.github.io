...
![](https://static001.geekbang.org/resource/image/2a/30/2aeb8de91aa7a638d71f558e6182d730.png?wh=896x494){: referrerpolicy="no-referrer" }
...
![](https://static001.geekbang.org/resource/image/47/27/4772208d2b17449be832934343b82627.png?wh=1000x240){: referrerpolicy="no-referrer" }

这还是一个比较简单的例子，有时候，我们需要做的事情稍微复杂一点，就像下面这个例子里，需要判断名字里是否只包含汉字。

![](https://static001.geekbang.org/resource/image/66/18/665a690ea33ea34d2e29593e9ab94e18.png?wh=1116x224){: referrerpolicy="no-referrer" }
