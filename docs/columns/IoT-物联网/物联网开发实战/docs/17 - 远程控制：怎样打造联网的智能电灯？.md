...
![](https://static001.geekbang.org/resource/image/a8/4f/a8a8c11d4be7c1e1c6fd69b2febed24f.png?wh=1118%2A998){: referrerpolicy="no-referrer" }

### 创建项目和产品

登录之后，我们直接进入准备工作的第二步，创建项目和产品。我们先在物联网开发平台创建一个新项目“智能家居”。

![](https://static001.geekbang.org/resource/image/bc/81/bc6d5d04e08bae0939c3a783775fd281.png?wh=1202%2A730){: referrerpolicy="no-referrer" }
...
![](https://static001.geekbang.org/resource/image/cd/f0/cdac3c2b897e53917e9afd6aa28ca7f0.png?wh=1276%2A1184){: referrerpolicy="no-referrer" }
...
![](https://static001.geekbang.org/resource/image/15/22/153908e6522de593d07d46346e879722.png?wh=2464%2A1178){: referrerpolicy="no-referrer" }
...
![](https://static001.geekbang.org/resource/image/62/27/62a990cf4a6ea288f9770445134a1f27.png?wh=1096%2A1056){: referrerpolicy="no-referrer" }
...
![](https://static001.geekbang.org/resource/image/75/54/759caa00ed7f5ebd1c001b18f4808054.png?wh=1198%2A506){: referrerpolicy="no-referrer" }

创建成功后，在测试设备列表中，点击“Led\_1”，进入设备的详情页面：

![](https://static001.geekbang.org/resource/image/9d/e9/9db3727e33082f821c8f21c6b642c1e9.png?wh=2266%2A686){: referrerpolicy="no-referrer" }
...
![](https://static001.geekbang.org/resource/image/97/a6/9721c6f1f394c14ca03e72dfe0c55ea6.png?wh=1866%2A624){: referrerpolicy="no-referrer" }

这是我在这个配置界面中定义的产品的二维码。

![](https://static001.geekbang.org/resource/image/b5/ff/b515137b43f769c249df48b7f6f550ff.png?wh=280%2A280){: referrerpolicy="no-referrer" }
...
![](https://static001.geekbang.org/resource/image/63/y4/633d089ea84047198dd53f560488fyy4.jpg?wh=2700%2A765){: referrerpolicy="no-referrer" }
...
![](https://static001.geekbang.org/resource/image/66/31/66f9943cc758b8d42e165caa47ed7c31.jpg?wh=2700%2A1842){: referrerpolicy="no-referrer" }
...
![](https://static001.geekbang.org/resource/image/d5/ae/d53af13yy9320eaa90b8ff6cf3c565ae.png?wh=791%2A703 "图片来自GitHub"){: referrerpolicy="no-referrer" }
...
![](https://static001.geekbang.org/resource/image/dd/61/dde075941211c591c44ea46cf4673861.png?wh=1306%2A1018){: referrerpolicy="no-referrer" }
...
![](https://static001.geekbang.org/resource/image/12/46/12623e989f7c3d29a7efc1a3e1d86246.jpg?wh=2700%2A2428){: referrerpolicy="no-referrer" }
...
![](https://static001.geekbang.org/resource/image/72/96/72db80e852a9d87a073c78f8d5272e96.png?wh=1792%2A1092){: referrerpolicy="no-referrer" }
...
![](https://static001.geekbang.org/resource/image/5d/28/5d03e52c440c12f7d0e00c972223dd28.png?wh=1330%2A1210){: referrerpolicy="no-referrer" }
...
![](https://static001.geekbang.org/resource/image/1d/7f/1d7b56914e783d7f5bfe18a633af2e7f.png?wh=1125%2A2436){: referrerpolicy="no-referrer" }

然后，点击设备卡片，进入设备交互界面，就可以进行远程控制了。

![](https://static001.geekbang.org/resource/image/40/5c/40969abc41cafa86910c231046099d5c.png?wh=1125%2A2436){: referrerpolicy="no-referrer" }
...
安可信nodemcu为什么需要呢？Flash芯片和ESP8266主芯片是通过SPI通信的，但是有不同的模式，一般Nodemcu模组是使用Quad I&#47;O 模式，但是这个安信可的板子使用的是Dual I&#47;O 模式，所以需要加这个参数明确指定一下。为什么这样采用DIO模式呢？因为这样可以额外空出2个GPIO管脚使用。嵌入式有时就是这样一个管脚都要珍惜。</p>2020-12-21</li><br/><li><span>garlic</span> 👍（8） 💬（1）<p>1. 使用的这个TopicMQTT_CONTROL_TOPIC = &quot;$thing&#47;down&#47;property&#47;&quot;+PRODUCT_ID+&quot;&#47;&quot;+DEVICE_NAME  终端通过 mqtt_client.subscribe，订阅这个Topic的消息
