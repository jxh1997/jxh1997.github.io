...
![图片](https://static001.geekbang.org/resource/image/a8/3e/a8a316694a0d7fde4d37d4459549043e.png?wh=1580x364 "在 OpenAI 的官方文档可以看到，Completions API 已经打上了 Legacy 的标记"){: referrerpolicy="no-referrer" }
