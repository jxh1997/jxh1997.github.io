...
![图片](https://static001.geekbang.org/resource/image/91/19/9110ece16990bf06ed1ddb60c9989a19.jpg?wh=1920x572){: referrerpolicy="no-referrer" }
...
![图片](https://static001.geekbang.org/resource/image/21/90/21ef69a6c3fcd37d4154a206c774f890.jpg?wh=1920x1207){: referrerpolicy="no-referrer" }

## 为什么需要向量数据库？

![图片](https://static001.geekbang.org/resource/image/19/0c/19b0e3823b4b9158de7eb11cebac630c.jpg?wh=1920x758){: referrerpolicy="no-referrer" }
...
![图片](https://static001.geekbang.org/resource/image/01/09/01af1033b844ce52d46878a263ef2209.jpg?wh=1920x498){: referrerpolicy="no-referrer" }
...
![图片](https://static001.geekbang.org/resource/image/90/d6/90a727190bb09d4910d769396f141bd6.jpg?wh=1920x821){: referrerpolicy="no-referrer" }

## 常用向量数据库

下面列出十个目前主流的向量数据库，展示其数据库链接、介绍、优点与缺点。根据开发者具体的使用场景和技术需求，选择最适合的向量数据库解决方案是关键。

![图片](https://static001.geekbang.org/resource/image/c2/cc/c27b4yy6748a414dae0c679835a1eccc.jpg?wh=1920x1197){: referrerpolicy="no-referrer" }
