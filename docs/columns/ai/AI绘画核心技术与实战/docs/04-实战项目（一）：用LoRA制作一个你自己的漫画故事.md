...
![](https://static001.geekbang.org/resource/image/ef/4e/efffcac60c71a7ef588b39090a0e0e4e.jpg?wh=4196x2480){: referrerpolicy="no-referrer" }
...
![](https://static001.geekbang.org/resource/image/a2/34/a2d5c8ceda5990429f88d1dfc9d69534.jpg?wh=2070x965){: referrerpolicy="no-referrer" }
...
![](https://static001.geekbang.org/resource/image/f9/ec/f9751b5944d79168e4d99612d5f358ec.jpg?wh=1411x817){: referrerpolicy="no-referrer" }
...
![](https://static001.geekbang.org/resource/image/75/8a/75cb73470e187b94858dff79705c968a.jpg?wh=2406x1276){: referrerpolicy="no-referrer" }

我们将其下载并放入 stable-diffusion-webui/models/Lora文件夹，可以在WebUI中看到。

![](https://static001.geekbang.org/resource/image/7c/93/7c59c91ccecb3243be47b35f067df993.jpg?wh=2830x1318){: referrerpolicy="no-referrer" }
...
![](https://static001.geekbang.org/resource/image/14/24/149eb5557234634177593f95e17c5524.jpg?wh=3622x2480){: referrerpolicy="no-referrer" }
...
![](https://static001.geekbang.org/resource/image/1b/db/1bd57bf049c85ac3ba71374495ebd2db.jpg?wh=3552x2480){: referrerpolicy="no-referrer" }
...
![](https://static001.geekbang.org/resource/image/8c/47/8c3f8494d2df07f276687abe5f29b847.jpg?wh=3595x2480){: referrerpolicy="no-referrer" }

生成效果完全不一样，看来确实是LoRA起到了关键作用，让图像呈现盲盒风格。那么LoRA的weights又会产生什么影响呢？

试一试才知道，我们继续修改小男孩的prompt。

![](https://static001.geekbang.org/resource/image/00/5a/009d3afdb96ac5fbbcbcd3128856105a.jpg?wh=3600x2994){: referrerpolicy="no-referrer" }
...
![](https://static001.geekbang.org/resource/image/af/cd/af9d24ac23382d9a21964aa335a325cd.jpg?wh=1437x899){: referrerpolicy="no-referrer" }
...
![](https://static001.geekbang.org/resource/image/97/e2/979829fa6646892fdeb4c2fd588533e2.jpg?wh=3957x4939){: referrerpolicy="no-referrer" }
...
![](https://static001.geekbang.org/resource/image/c7/df/c7c7d2d4d37880211294765b042449df.jpg?wh=1277x731){: referrerpolicy="no-referrer" }

这里分享一个实用的技巧。在使用WebUI进行漫画制作时，**我们可以先通过文生图功能验证基础效果，确认没问题后使用超分功能进行高分辨率处理**。使用超分模块也很简单，只需要像下面图中一样，勾选超分功能即可。

![](https://static001.geekbang.org/resource/image/b5/42/b50ec5890634b6e88a2e633c1ff1e142.jpg?wh=2099x726){: referrerpolicy="no-referrer" }

然后我们根据实际情况，对超分的参数进行设置，比如上采样倍率设置为2，可以将分辨率提升一倍。细心的你也许注意到右侧也有一个重绘强度选项，是的，这里的用法类似于我们已经学过的图生图功能。你可以根据自己的实际需求进行设置。

![](https://static001.geekbang.org/resource/image/2b/06/2ba80295ac42192038dc22e9e858b206.jpg?wh=1900x638){: referrerpolicy="no-referrer" }
...
![](https://static001.geekbang.org/resource/image/1c/df/1c666c77a7f2d3708ce0eb1a748d68df.jpg?wh=4000x3874){: referrerpolicy="no-referrer" }
...
![](https://static001.geekbang.org/resource/image/58/cc/58f062cd47b050c32ac9b725c773f9cc.jpg?wh=1674x768){: referrerpolicy="no-referrer" }
