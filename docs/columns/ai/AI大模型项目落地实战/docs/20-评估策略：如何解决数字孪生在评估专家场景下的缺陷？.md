...
![图片](https://static001.geekbang.org/resource/image/8b/09/8b40cc613d3c077c81335a2e2a49e209.png?wh=1920x813)  {: referrerpolicy="no-referrer" }
总结一下：
...
![图片](https://static001.geekbang.org/resource/image/8d/7a/8dc63bfeaa155ee009d2773cf4b9417a.png?wh=1920x1250)  {: referrerpolicy="no-referrer" }
![图片](https://static001.geekbang.org/resource/image/1b/b2/1b1f814b28799f37e00c80181901f3b2.png?wh=1920x1386){: referrerpolicy="no-referrer" }
...
![图片](https://static001.geekbang.org/resource/image/1b/yy/1b010ee8065f57089c1c98a70a610eyy.png?wh=1920x404){: referrerpolicy="no-referrer" }

最终训练完成会给出结果数据，这个结果实际上是拿test数据集来做的评估，重点关注 `eval_acc` 字段的结果，表示预测的准确率。

![图片](https://static001.geekbang.org/resource/image/4d/d9/4d0fd3532dc71f5972d466100f879cd9.png?wh=848x304)  {: referrerpolicy="no-referrer" }
...
![图片](https://static001.geekbang.org/resource/image/fe/3e/fe25d5592cf16e3e605dc7c260e2bb3e.png?wh=1100x368){: referrerpolicy="no-referrer" }
