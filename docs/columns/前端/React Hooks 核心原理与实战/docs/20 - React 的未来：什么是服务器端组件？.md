...
![](https://static001.geekbang.org/resource/image/24/4a/2489110bff22e21c45b8f7ab9b07084a.png?wh=1680x1299){: referrerpolicy="no-referrer" }
...
下面这张图显示了这样一个转换的过程：  
![](https://static001.geekbang.org/resource/image/11/40/11f088yy105ffd52c7306bc310c9f440.png?wh=1326x438)  {: referrerpolicy="no-referrer" }
