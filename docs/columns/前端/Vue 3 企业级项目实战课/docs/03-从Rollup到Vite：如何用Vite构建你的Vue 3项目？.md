...
![图片](https://static001.geekbang.org/resource/image/5c/bf/5cac21491252453a04d3305948a6fbbf.png?wh=1588x738){: referrerpolicy="no-referrer" }

根据提示，我们可以通过浏览器直接访问 [http://localhost:6001](http://localhost:6001) 查看开发模式结果：

![图片](https://static001.geekbang.org/resource/image/0c/5f/0cb4870c9063240d2c689a5afe386e5f.png?wh=1324x822){: referrerpolicy="no-referrer" }

执行完开发模式后，我们可以执行以下生产模式命令 npm run build，执行完后结果如下：

![图片](https://static001.geekbang.org/resource/image/e0/db/e089741fdfcda43528182a4afc6b2fdb.png?wh=1478x738){: referrerpolicy="no-referrer" }
...
![图片](https://static001.geekbang.org/resource/image/6f/3f/6f219bf8b0e839cd3c9c05e6e44aa93f.png?wh=1920x1293){: referrerpolicy="no-referrer" }
...
![图片](https://static001.geekbang.org/resource/image/fa/f2/fa1b9179346b8d8a7c2c294194125af2.png?wh=1920x1266){: referrerpolicy="no-referrer" }
...
![图片](https://static001.geekbang.org/resource/image/00/68/0012a0ab91a7db94cdd118eae4bc2c68.png?wh=1920x1082){: referrerpolicy="no-referrer" }
