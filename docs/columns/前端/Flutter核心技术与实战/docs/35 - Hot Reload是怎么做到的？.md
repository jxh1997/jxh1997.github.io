...
![](https://static001.geekbang.org/resource/image/ab/a3/ab692d1e072df378bc78fef6245205a3.png?wh=1502%2A542){: referrerpolicy="no-referrer" }

图1 JIT编译模式示意图

- AOT（Ahead Of Time），指的是提前编译或运行前编译，在Release模式中使用，可以为特定的平台生成稳定的二进制代码，执行性能好、运行速度快，但每次执行均需提前编译，开发调试效率低。

![](https://static001.geekbang.org/resource/image/fe/a5/fe8712b8a36a032b0646ed85fec9b2a5.png?wh=1308%2A392){: referrerpolicy="no-referrer" }
...
![](https://static001.geekbang.org/resource/image/2d/fa/2dfbedae7b95dd152a587070db4bb9fa.png?wh=900%2A528){: referrerpolicy="no-referrer" }
