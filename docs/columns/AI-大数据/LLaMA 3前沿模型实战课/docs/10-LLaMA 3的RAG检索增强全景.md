...
![图片](https://static001.geekbang.org/resource/image/1d/52/1d1c476be5d5d3fd9700a9d26aac0552.png?wh=1342x650 "Llama-index High-Level Concepts https://docs.llamaindex.ai/en/stable/getting_started/concepts/"){: referrerpolicy="no-referrer" }
