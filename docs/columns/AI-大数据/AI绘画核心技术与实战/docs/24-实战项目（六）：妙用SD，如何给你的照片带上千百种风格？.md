...
![](https://static001.geekbang.org/resource/image/96/9e/96630d2d677f90a786c83fa09173889e.jpg?wh=4269x2480){: referrerpolicy="no-referrer" }
...
![图片](https://static001.geekbang.org/resource/image/58/f4/58194e5737d5d7cc8f71f879bc17a4f4.gif?wh=315x564){: referrerpolicy="no-referrer" }
...
![](https://static001.geekbang.org/resource/image/08/f8/0814424ab7760df7af992489153862f8.png?wh=2449x905){: referrerpolicy="no-referrer" }
...
![](https://static001.geekbang.org/resource/image/30/65/30d660982dfc61463449b3406cb2a865.png?wh=1827x658){: referrerpolicy="no-referrer" }

事实上，上面呈现的算法效果都只能实现脸部区域的风格化，并不能稳定地处理全部图像区域。这便引出了一个大家都想解决的技术难题——全图风格化。这个难题直到2022年9月VToonify这个技术提出后，才算是被解决。

![图片](https://static001.geekbang.org/resource/image/43/7c/433129ee6696b716f11281c3990c317c.gif?wh=1078x592){: referrerpolicy="no-referrer" }

VToonify本质上仍旧是StyleGAN系列工作的扩展，也就是想办法在GAN的生成器中注入风格信息。它的整体思路你可以结合后面的图片来理解。

![](https://static001.geekbang.org/resource/image/a4/65/a41aee1d40507e7a6267e02ffe7bbf65.png?wh=1297x562){: referrerpolicy="no-referrer" }
...
![](https://static001.geekbang.org/resource/image/79/be/7934e034d0f4f5d2522e951471f063be.jpeg?wh=1024x1024 "https://midlibrary.io/styles/abstract-art"){: referrerpolicy="no-referrer" }

![](https://static001.geekbang.org/resource/image/1d/ac/1d75fda845aff9188c9fa501dcb70bac.jpeg?wh=1024x1024 "https://midlibrary.io/styles/anime-style"){: referrerpolicy="no-referrer" }

![](https://static001.geekbang.org/resource/image/0a/a0/0aa150c24f697bf902124557a9465ea0.jpeg?wh=1024x1024 "https://midlibrary.io/styles/arcology"){: referrerpolicy="no-referrer" }

![](https://static001.geekbang.org/resource/image/60/70/60076d0cd95cac65b9835107287f5070.jpeg?wh=1280x1280 "https://midlibrary.io/styles/caricature"){: referrerpolicy="no-referrer" }

![](https://static001.geekbang.org/resource/image/be/4a/be64977be6d8042050f174178ce3a14a.jpeg?wh=1024x1024 "https://midlibrary.io/styles/pop-art"){: referrerpolicy="no-referrer" }

![](https://static001.geekbang.org/resource/image/9d/42/9d193648bf4ba07d7125861989f0cd42.jpeg?wh=1024x1024 "https://midlibrary.io/styles/post-impressionism"){: referrerpolicy="no-referrer" }
...
![](https://static001.geekbang.org/resource/image/d4/b6/d4301d5047a36f036401ec78bd5f3cb6.png?wh=1536x1024){: referrerpolicy="no-referrer" }
...
![](https://static001.geekbang.org/resource/image/92/4e/9290a5ddd6ca94942618e68b7d37ff4e.png?wh=1536x1024){: referrerpolicy="no-referrer" }
...
![](https://static001.geekbang.org/resource/image/50/59/50f23f65291699243726224b71ae5e59.jpg?wh=1610x778){: referrerpolicy="no-referrer" }
...
![](https://static001.geekbang.org/resource/image/e8/e2/e89a4205fe71acb52e95db2a6b53cfe2.png?wh=1600x1552){: referrerpolicy="no-referrer" }

我们也可以尝试通过指令将图片调整为更多有意思的风格。

![](https://static001.geekbang.org/resource/image/4c/97/4c1b5d50881fb9f7acaf81e8e2ef0797.jpg?wh=1600x1552){: referrerpolicy="no-referrer" }
...
![](https://static001.geekbang.org/resource/image/67/a6/673682d72c70e382887d1687a802dfa6.png?wh=1158x646){: referrerpolicy="no-referrer" }

在Add difference这个模式下，我们需要提供三个模型，将模型B和模型C的权重差值以一定的权重加到原始模型A上。融合后模型权重的计算方式你可以看后面的公式，公式中的M仍是加权系数。

新模型权重 = 模型A + (模型B - 模型C) * M

![](https://static001.geekbang.org/resource/image/e8/38/e8491352ab7a41ebc34d8330f3343338.png?wh=1155x649){: referrerpolicy="no-referrer" }
...
![](https://static001.geekbang.org/resource/image/42/aa/4251848d15c758b05d7254c89770deaa.png?wh=1163x647){: referrerpolicy="no-referrer" }

然后我们使用融合后的模型生成图像，用相同的prompt与原始模型做一个对比。可以看到，我们调制的新风格与用于融合的两个模型是有明显差异的。

![](https://static001.geekbang.org/resource/image/34/f2/343fecf52461bb395e51fd33a4736df2.jpg?wh=4242x2480){: referrerpolicy="no-referrer" }
...
![](https://static001.geekbang.org/resource/image/34/82/34c758ecbecb16f230f41aaae3262382.jpg?wh=4000x2818){: referrerpolicy="no-referrer" }
