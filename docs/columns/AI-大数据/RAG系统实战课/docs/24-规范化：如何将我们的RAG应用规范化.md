...
![](https://static001.geekbang.org/resource/image/c0/09/c0f7f865f8517da0e288ae3b1665e009.jpg?wh=6904x8808){: referrerpolicy="no-referrer" }

点击该图标之后，你将进入以下界面。

![](https://static001.geekbang.org/resource/image/ef/17/efb3a5cce026d5b4d34b35ec543ceb17.jpg?wh=3030x1910){: referrerpolicy="no-referrer" }
...
![](https://static001.geekbang.org/resource/image/a6/e7/a69dd106ed20851af81f7dac2f422ee7.jpg?wh=2290x467){: referrerpolicy="no-referrer" }

然后我们将会在通义灵码插件界面看到后面的生成结果。

![](https://static001.geekbang.org/resource/image/af/9f/afc0d4d3f30b19fbc947263cf554ef9f.jpg?wh=3352x4894){: referrerpolicy="no-referrer" }
...
![](https://static001.geekbang.org/resource/image/35/1a/35df276a526ebf1fbcd09d1bc3eebf1a.jpg?wh=2961x4333){: referrerpolicy="no-referrer" }
...
![](https://static001.geekbang.org/resource/image/da/dc/da0ba78ba0846d99ea67f4244bf9f7dc.jpg?wh=2579x1109){: referrerpolicy="no-referrer" }
...
![](https://static001.geekbang.org/resource/image/bd/24/bd49aaa9611356f5257a5yy6034f5f24.jpg?wh=2963x582){: referrerpolicy="no-referrer" }

然后通义灵码插件界面就会生成后面这样的结果。

![](https://static001.geekbang.org/resource/image/2b/1a/2b695c327ddd772f33fec8e3228dff1a.jpg?wh=2954x2864){: referrerpolicy="no-referrer" }

我们可以看到，这里和刚才不一样了，AI并没有生成单元测试用例，而是提示我们用哪个单元测试框架。我的习惯是使用 `pytest`，你也可以根据你的习惯来选择相应的单元测试框架。

点击`使用pytest库`按钮之后，AI将会生成单元测试建议。

![](https://static001.geekbang.org/resource/image/11/2d/11bd165093f92c44ecb340a15a35a02d.jpg?wh=3328x5187){: referrerpolicy="no-referrer" }
