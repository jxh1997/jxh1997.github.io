...
![](https://static001.geekbang.org/resource/image/f5/33/f5c825822aca8a7ae763ab2dacd47d33.jpg?wh=2226x680){: referrerpolicy="no-referrer" }
...
![](https://static001.geekbang.org/resource/image/1d/00/1d1a511f2a51f31e0ae04ecec7da8f00.jpg?wh=1855x1400){: referrerpolicy="no-referrer" }

你现在知道了，既然 Ollama 提供了服务，One API 当然可以通过服务接口连接它。配置Ollama 服务，主要是根据自己的需要配置所需的模型。

![](https://static001.geekbang.org/resource/image/e9/bb/e99f9fa57ccc00807e6f41d6abc532bb.jpg?wh=4617x1638){: referrerpolicy="no-referrer" }
...
![图片](https://static001.geekbang.org/resource/image/d4/ac/d446227dd3fb14ced7432f37f31eb0ac.gif?wh=1878x1244){: referrerpolicy="no-referrer" }
