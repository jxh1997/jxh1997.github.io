...
![图片](https://static001.geekbang.org/resource/image/aa/7a/aa939d818820b0797280d431cc87037a.png?wh=1920x1452 "LLMathChain通过OpenAI生成Python代码，再通过REPL执行Python代码，完成数学计算"){: referrerpolicy="no-referrer" }
...
![图片](https://static001.geekbang.org/resource/image/e2/45/e29294012c309f3f808693cea5216445.png?wh=1920x2181 "通过三个步骤，拿到最后结构化的天气信息"){: referrerpolicy="no-referrer" }
