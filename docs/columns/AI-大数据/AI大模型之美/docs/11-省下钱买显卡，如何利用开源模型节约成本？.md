...
![图片](https://static001.geekbang.org/resource/image/1c/21/1c0791bd5c1e088eeb527f2acb81a021.png?wh=1255x584){: referrerpolicy="no-referrer" }

1. 你先选择菜单栏里的Runtime，然后点击Change runtime type。

<!--THE END-->

![图片](https://static001.geekbang.org/resource/image/50/23/502a4baceab267e949957c6477bc5823.png?wh=1257x489){: referrerpolicy="no-referrer" }
