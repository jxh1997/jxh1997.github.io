...
![](https://static001.geekbang.org/resource/image/1e/81/1e7533f765d2ede0abfab73cf6b57781.png?wh=1863%2A2271){: referrerpolicy="no-referrer" }
...
![unpreview](https://static001.geekbang.org/resource/image/36/b3/36b6a41da6e9abc2fc28ee9a305f48b3.jpg?wh=1142%2A155){: referrerpolicy="no-referrer" }
...
![unpreview](https://static001.geekbang.org/resource/image/4e/56/4eab55dc3600071330e088b40cae4856.png?wh=1769%2A2306){: referrerpolicy="no-referrer" }
...
需要把目的地的经纬度换成地址名——DNS
需要中间中转一下——Proxy
HTTP——我不那么多，我向你要什么你就给什么</p>2020-03-24</li><br/><li><span>Atomic</span> 👍（41） 💬（8）<p>打个比方：我让老婆帮我去楼下超市买瓶水，DNS可以帮她找到楼下超市，URI可以帮她找到水放在超市的具体位置</p>2019-06-06</li><br/><li><span>Shine Sunner</span> 👍（24） 💬（1）<p>1.假如去某个小区找人，DNS可以帮我定位到是哪栋大楼，URI可以帮我定位到是哪个房间。
2.
正向代理:
...
反向代理:
  ...
  总结:
   ...
   反向代理的代理服务器是部署在服务端，而对客户端来说，它以为对它做出响应的是代理服务器，而真正响应的服务端对客户端来说是不可见的。</p>2020-01-01</li><br/><li><span>一粟</span> 👍（19） 💬（3）<p>小强家钥匙丢了，需要找一家开锁公司开门。于是小强打电话给114，114给小强提供一家有资质的开锁公司，并将电话转接过去。这里的114就是代理。</p>2019-06-05</li><br/><li><span>蚂蚁内推+v</span> 👍（13） 💬（3）<p>1. URL 包含了协议+主机名+路径，DNS 会将其中的主机名解析为 IP，进而方便根据 IP 协议进行寻址、路由；
